                        ...
                        <div class="box text-center text-primary mb-5">
                            ...
                            <form method="post">
                                <div class="text-center form-group mt-3">
                                    <div class="col-sm-12">
                                        <input class="text-center" required type="hidden" name="enseignant_id" class="form-control" value="<?php echo $comptes->enseignant_id; ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="mt-3">
                                        <a href='<?= site_url('page/cursusenseignant'); ?>' class='btn btn-primary'>Annuler</a>
